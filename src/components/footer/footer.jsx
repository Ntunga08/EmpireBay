...
const Footer = () => {
  return (
    <footer className="bg-[#142720] text-white py-12">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-white">Empire Bay</h3>
            <p className="text-blue-200 leading-relaxed">
              Bagamoyo's ultimate destination for live music, quality beers, 
              and unforgettable experiences. Where every night is legendary.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/gallery" className="text-blue-200 hover:text-white transition">Events</Link></li>
              <li><a href="#menu" className="text-blue-200 hover:text-white transition">Menu</a></li>
              <li><Link to="/gallery" className="text-blue-200 hover:text-white transition">Gallery</Link></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li><span className="text-blue-200">Live Music Events</span></li>
              <li><span className="text-blue-200">Premium Beers</span></li>
              <li><span className="text-blue-200">Signature Cocktails</span></li>
              <li><span className="text-blue-200">Sports Viewing</span></li>
              <li><span className="text-blue-200">Karaoke Nights</span></li>
              <li><span className="text-blue-200">Private Events</span></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-blue-200">
              <div className="flex items-start space-x-3">
                ...
                <span>123 Bar Street, Bagamoyo, Tanzania</span>
              </div>
        ...
        <div className="border-t border-blue-800 pt-8 mb-8">
          <div className="text-center space-y-4">
            ...
            <div className="flex max-w-md mx-auto">
              ...
              />
              <button className="bg-blue-700 hover:bg-blue-600 px-6 py-2 rounded-r-lg transition">
                Subscribe
              </button>
            </div>
          </div>
